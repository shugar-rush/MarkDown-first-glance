## Hi There ! THis is the title TYPES AND COMMANDS  (Title ##)


### This is a hands on Markdown guide (Sub-Title ###) A MARKDOWN CHEAT SHEET 

#### To make text **bold**, use double asterisks `**text**`.

- _Emphasis_, or italic, is done with single underscores: _like this_.

* List item with [a link to google site](http://google.com).
* 
- * Lists start with an asterisk (*), plus sign (+), or hyphen (-).
- Element list 1
- Element list 2
* Element list 3
* Element list 4
...
1 also
2 I can create
3  a numered listwords with thiswords with this

NESTED LISTS
You can nest lists by indenting them. Here's an example of a nested list in Markdown:
- Level one
     - level 1.1
       - level 1.1.1
...
> If markdown will take several paragraps to indicate that all are the same cite yo umust use ( > + >)
> like this

> You can also nest cites
>> so here it is
...
terraza
 ...
 el puto gorrion mamon

(as html md doesn´t allow double intro, it means in the md document will not appear double intro space)
but one

BLOQ CODE ALT + 126 ~

~~~
THIS IS A BLOQ TO USE IF YOU WANT TO 
CREATE A HOLE BLOQ OF CODE OR SOMENTING ELSE.
IT WORS AS A PRE TAG <pre>
~~~
...
***bold and cursive***
_**bold and cursive**_
__*bold and cursive*__
___bold and cursive___    no good
